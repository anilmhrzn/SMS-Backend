...
class StudentController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        $studentsArray = $this->studentQueryInterface->findByUser($userId, $limit, $page);
        $totalStudents = $this->studentQueryInterface->getTotalStudentsCountOfUser($userId);
...
//        $paginator = $this->studentService->findAllByLimitAndPage($limit, $page);
//        $totalStudents = count($paginator);
//        return new JsonResponse([
//            'students' => $paginator,
//            'total' => $totalStudents,
//            'page' => $page,
...
//    }
    ...
    public function indexByUser(StudentRepository $studentRepository, Request $request): Response
    {
        ...
        $studentsArray = $this->studentQueryInterface->findByStudentId($studentId);
